...
export default function TipModal({ onClose, onSave, initialData }: TipModalProps) {
  ...
  const handleSave = () => {
    if (!analysis || matches.some(m => !m.homeTeam || !m.awayTeam || !m.prediction)) {
    ...
    const newTip: Tip = {
      ...
      isVip,
      status: initialData?.status || TicketStatus.PENDING,
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-6 bg-black/80 backdrop-blur-sm">
      ...
      >
        ...
        <h2 className="text-3xl font-display font-bold mb-8">Novi Tip</h2>
