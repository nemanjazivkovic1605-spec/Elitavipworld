        ...
        <div className="hidden md:flex items-center gap-4">
          {user ? (
            <div className="flex items-center gap-6">
               <Link to="/dashboard" className="text-xs font-black uppercase tracking-widest text-gold-500 hover:text-gold-600 transition-colors">
                 Dashboard
               </Link>
               <div className="flex items-center gap-3">
                 <span className="text-[10px] font-bold text-neutral-500 uppercase tracking-tighter">{user.email}</span>
                 <button 
                  onClick={logout}
            ...
            <div className="px-6 py-8 flex flex-col gap-6">
              ...
              {user ? (
                 <div className="flex flex-col gap-6">
                   <div className="text-xs font-bold text-neutral-500 uppercase tracking-widest">{user.email}</div>
                   <button 
