    ...
    <div className="max-w-7xl mx-auto px-6 py-10">
      ...
      {loading ? (
        ...
        <div className="text-center py-32 glass rounded-[3rem]">
           ...
           <h3 className="text-xl font-bold mb-2">Rezultati trenutno nisu dostupni</h3>
           <p className="text-neutral-500 max-w-sm mx-auto">Za izabrani datum ({selectedDate}) nema podataka o mečevima u našoj bazi.</p>
           <button 
